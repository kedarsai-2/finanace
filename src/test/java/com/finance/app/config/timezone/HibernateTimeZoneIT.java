package com.finance.app.config.timezone;

import static java.lang.String.format;
import static org.assertj.core.api.Assertions.assertThat;

import com.finance.app.IntegrationTest;
import com.finance.app.repository.timezone.DateTimeWrapper;
import com.finance.app.repository.timezone.DateTimeWrapperRepository;
import java.time.*;
...
class HibernateTimeZoneIT {
  ...
  void setup() {
    ...
    dateTimeFormatter = DateTimeFormatter.ofPattern("yyyy-MM-dd HH:mm:ss.S").withZone(
      ZoneId.of(zoneId)
    );
