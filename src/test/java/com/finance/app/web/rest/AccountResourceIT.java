...
import com.finance.app.config.Constants;
import com.finance.app.domain.User;
import com.finance.app.repository.AuthorityRepository;
import com.finance.app.repository.UserRepository;
import com.finance.app.security.AuthoritiesConstants;
import com.finance.app.service.UserService;
import com.finance.app.service.dto.AdminUserDTO;
import com.finance.app.service.dto.PasswordChangeDTO;
import com.finance.app.web.rest.vm.KeyAndPasswordVM;
import com.finance.app.web.rest.vm.ManagedUserVM;
...
class AccountResourceIT {
  ...
  void testRegisterDuplicateEmail() throws Exception {
    ...
    assertThat(testUser4.orElseThrow().getEmail()).isEqualTo(
    ...
    restAccountMockMvc
      .perform(
        post("/api/account/change-password")
          .contentType(MediaType.APPLICATION_JSON)
          .content(
            om.writeValueAsBytes(new PasswordChangeDTO("1" + currentPassword, "new password"))
          )
      )
      .andExpect(status().isBadRequest());
  ...
  void testRequestPasswordResetUpperCaseEmail() throws Exception {
    ...
    restAccountMockMvc
      .perform(
        post("/api/account/reset-password/init").content("password-reset-upper-case@EXAMPLE.COM")
      )
      .andExpect(status().isOk());
  ...
  void testRequestPasswordResetWrongEmail() throws Exception {
    restAccountMockMvc
      .perform(
        post("/api/account/reset-password/init").content("password-reset-wrong-email@example.com")
      )
      .andExpect(status().isOk());
  }
