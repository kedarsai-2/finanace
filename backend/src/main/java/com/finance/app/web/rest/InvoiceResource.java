...
/**
 * REST controller for managing {@link com.finance.app.domain.Invoice}.
 */
@RestController
...
public class InvoiceResource {
    ...
    /**
     * {@code GET /invoices/:id/lines} : get all lines for an invoice.
     *
     * Frontend uses this to load invoice items on demand.
     */
    @GetMapping("/{id}/lines")
    public List<InvoiceLineDTO> getInvoiceLines(@PathVariable("id") Long id) {
        LOG.debug("REST request to get InvoiceLines for invoiceId: {}", id);
        return invoiceLineService.findAllByInvoiceId(id);
    }
