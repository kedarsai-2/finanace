...
class MailServiceIT {
  ...
  void testSendMultipartEmail() throws Exception {
    ...
    MimeBodyPart part = (MimeBodyPart) ((MimeMultipart) mp.getBodyPart(0).getContent()).getBodyPart(
      0
    );
  ...
  void testSendLocalizedEmailForAllSupportedLanguages() throws Exception {
    ...
    for (String langKey : languages) {
      ...
      properties.load(
        new InputStreamReader(Files.newInputStream(filePath), Charset.forName("UTF-8"))
      );
