...
/**
 * Criteria class for the {@link com.finance.app.domain.Purchase} entity. This class is used
 * in {@link com.finance.app.web.rest.PurchaseResource} to receive all the possible filtering options from
...
public class PurchaseCriteria implements Serializable, Criteria {
    ...
    public Optional<PurchaseStatusFilter> optionalStatus() {
        return Optional.ofNullable(status);
    }

    public PurchaseStatusFilter status() {
        if (status == null) {
            setStatus(new PurchaseStatusFilter());
        }
        return status;
    }
